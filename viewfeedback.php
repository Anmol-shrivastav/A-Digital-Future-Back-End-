...
<div class="container-fluid">
 ...
 ?>
 <form  action="feedbackreply.php" method="post" style="width:400px; text-align:left">
   ...
   <div class="form-group">
   <label>Message</label>
   <textarea class="form-control" rows="5" readonly style="background-color:white">
