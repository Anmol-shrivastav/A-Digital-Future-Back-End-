...
<div class="container-fluid">
 ...
 <div class="col-lg-4 col-md-4 col-sm-4 col-4" style="width:100%">
    <button class="btn btn-dark" onClick="location.href='addcard.php'">Add Card</button>
 </div>
  ...
  <table>
	 ...
	 ?>
        <tr>
          ...
          <td><a href="editcard.php?ID=<?php echo $row['ID'];?>
          &TITLE=<?php echo $row['TITLE']; ?>"><i>Edit.</i></a></td>
          <td><a href="deletecard.php?ID=<?php echo $row['ID']; ?>
          &TITLE=<?php echo $row['TITLE']; ?>"><i>Delete.</i></a></td>
        </tr>
        <?php }}?>
