    ...
    <ul class="navbar-nav mr-auto">
       <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item active" href="homecard.php">Card</a>
        </div>
      </li>
      <li class="nav-item dropdown">
...
<div class="container-fluid">
 ...
 <div class="col-lg-8 col-md-8 col-sm-8 col-8">
   <h2><?php echo $page." "."Templates"; ?></h2>
 </div>
 <div class="col-lg-4 col-md-4 col-sm-4 col-4" style="width:100%">
    <button class="btn btn-dark" 
    onClick="location.href='addtemplates.php?TITLE=<?php echo $page;?>'">
    Add Template</button>
 </div>
  ...
  <table>
	 ...
	 ?>
        <tr>
          ...
          <td><a href="edittemplates.php?ID=<?php echo $row['ID'];?>
          &TITLE=<?php echo $page; ?>"><i>Edit.</i></a></td>
          <td><a href="deletetemplates.php?ID=<?php echo $row['ID']; ?>
          &TITLE=<?php echo $page; ?>"><i>Delete.</i></a></td>
        </tr>
        <?php }}?>
