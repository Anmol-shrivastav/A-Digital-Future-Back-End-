    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item active" href="courses.php">Courses</a>
        </div>
      </li>
      <li class="nav-item">
...
<div class="container-fluid">
 ...
 <div class="col-lg-8 col-md-8 col-sm-8 col-8">
   <h2>Courses In Demand Section.</h2>
 </div>
 <div class="col-lg-4 col-md-4 col-sm-4 col-4" style="width:100%">
    <button class="btn btn-dark" onClick="location.href='addcourses.php'">
    Add Courses</button>
 </div>
 </div><!-- row div -->
 <div class="row">
  ...
  <table>
	 ...
	 ?>
        <tr>
          ...
          <td><a href="editcourses.php?ID=<?php echo $row['ID']; ?>"><i>Edit.</i></a></td>
          <td><a href="deletecourses.php?ID=<?php echo $row['ID']; ?>"><i>Delete.</i></a></td>
        </tr>
        <?php }}?>
