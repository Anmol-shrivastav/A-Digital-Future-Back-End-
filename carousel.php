...
<div class="container-fluid">
 ...
 <div class="col-lg-8 col-md-8 col-sm-8 col-8">
   <h2>Home Carousel</h2>
   <p>* Please Upload Images of Different Names.</p>
 </div>
 <div class="col-lg-4 col-md-4 col-sm-4 col-4" style="width:100%">
    <button class="btn btn-dark" onClick="location.href='addcarousel.php'">Add Carousel
    </button>
 </div>
 <div class="col-lg-12 col-md-12 col-sm-12 col col-12">
  ...
  <table>
     <thead style="background-color:#333">
       <tr>
         <th style="color:white">Carousel Id</th>
	 ...
	 ?>
        <tr>
          ...
          <td><a href="deletecarousel.php?ID=<?php echo $row['ID']; ?>"><i>delete.</i></a></td>
        </tr>
        <?php }}?>
     </tbody>
  </table>
